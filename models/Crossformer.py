...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.pad_in_len = ceil(1.0 * configs.seq_len /
                               self.seg_len) * self.seg_len
        self.pad_out_len = ceil(
            1.0 * configs.pred_len / self.seg_len) * self.seg_len
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        dec_in = repeat(self.dec_pos_embedding,
                        'b ts_d l d -> (repeat b) ts_d l d', repeat=x_enc.shape[0])
